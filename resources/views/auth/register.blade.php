...
<div class="container">
    <div class="row justify-content-center" >
        <div class="col-md-6" style="box-shadow: 10px 10px 8px #888888;">
            <div class="card">
                <div class="card-header text-center" style="background:white">
                   
                    <img src="images/logo.png" alt="" height="100px">
                </div>
                <h3 class="text-center m-2">User Registration</h3>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf

                        <div class="row mb-3">
                            <label for="First name" class="col-md-4 col-form-label text-md-end">{{ __('Full Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="Last name" class="col-md-4 col-form-label text-md-end">{{ __('User Name') }}</label>
